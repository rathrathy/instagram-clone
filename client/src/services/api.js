...
export const saveStory = async (data) => {
    try {
        return await axios.post(`${API_URL}/story/save`, data);
    } catch (error) {
        console.log('Error while calling saveStory API', error);
        return error.response;
    }
}
...
export const getAllStories = async () => {
    try {
        ...
        console.log('Error while calling getAllStories API', error);
        return error.response;
    }
}